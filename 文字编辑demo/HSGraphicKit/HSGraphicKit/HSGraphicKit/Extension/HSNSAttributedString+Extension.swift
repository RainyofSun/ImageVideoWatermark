//
//  HSNSAttributedString+Extension.swift
//  HSGraphicKit
//
...
extension NSAttributedString {
    ...
    func hs_sizeFittingWidth(_ w: CGFloat) -> CGSize {
...
extension NSAttributedString {
    ...
    func setStrokeWidth(_ width: CGFloat, range: NSRange?) -> NSAttributedString {
        return self.setKey(.strokeWidth, value: width, range: range)
    }
    func setStrokeColor(_ color: UIColor, range: NSRange?) -> NSAttributedString {
        return self.setKey(.strokeColor, value: color, range: range)
    }
    ...
    func setKernStyle(_ kernNum: CGFloat, range: NSRange?) -> NSAttributedString {
        return self.setKey(.kern, value: kernNum, range: range)
    }
    func setShadowStyle(_ shadow: NSShadow, range: NSRange?) -> NSAttributedString {
        return self.setKey(.shadow, value: shadow, range: range)
    }
    func setExpansionStyle(_ expansionNum: CGFloat, range: NSRange?) -> NSAttributedString {
        return self.setKey(.expansion, value: expansionNum, range: range)
    }
